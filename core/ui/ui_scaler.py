...
class UIScaler(GameHandle):
    ...
    def scaled_ui(self, name_scene):
        source_path, target_path = self.__get_source_and_target_paths(name_scene, 'style_ui.json')
        self.__merge_files(source_path, target_path)
        self.__scaled_ui_style(source_path, target_path)

        source_path, target_path = self.__get_source_and_target_paths(name_scene, 'ui.json')
        self.__merge_files(source_path, target_path)
